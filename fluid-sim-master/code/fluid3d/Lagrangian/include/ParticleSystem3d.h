...
namespace FluidSimulation
{
    ...
    namespace Lagrangian3d
    {
        ...
        struct particle3d
        {
            ...
            alignas(16) glm::vec3 force;//加了个力
            alignas(4) float_t Odensity;
        };
        ...
        public:
            ...
            bool isPenetrating(const glm::vec3& position) const {
                // 检查位置是否穿透边界
                return (position.x - particleRadius < lowerBound.x || position.x + particleRadius > upperBound.x ||
                    position.y - particleRadius < lowerBound.y || position.y + particleRadius > upperBound.y ||
                    position.z - particleRadius < lowerBound.z || position.z + particleRadius > upperBound.z);
            }
        public:
